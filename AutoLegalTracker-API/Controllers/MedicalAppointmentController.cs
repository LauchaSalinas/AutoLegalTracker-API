...
namespace LegalTracker.API.Controllers
{
    ...
    public class MedicalAppointmentController : ControllerBase
    {
        ...
        public MedicalAppointmentController(IConfiguration configuration, MedicalAppointmentService medicalAppointmentService, UserService userService)
        {
        ...
        public async Task<ActionResult> GetEvents(string calendarId, DateTime startDate, DateTime endDate)
        {
            ...
            try
            {
                var result = await _medicalAppointmentService.GetEvents(user, calendarId, startDate, endDate);
        ...
        public async Task<ActionResult> GetFreeBusy(string calendarId, string startDate, string endDate)
        {
            ...
            try
            {
                var result = await _medicalAppointmentService.GetFreeBusy(user, calendarId, startDateParsed, endDateParsed);
